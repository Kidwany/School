...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Teachers
            <small>Create New Teacher</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Teacher Info</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    @include('dashboard.layouts.messages')
                    <form role="form" action="{{route('teachers.store')}}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('post')
