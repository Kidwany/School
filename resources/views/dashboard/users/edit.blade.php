                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter User Name" value="{{$user->name}}">
                                </div>

                                <div class="col-lg-6">
                                    <label for="exampleInputEmail1"> Email</label>
                                    <input type="email" class="form-control" name="email" id="exampleInputEmail1" placeholder="Enter User Email" value="{{$user->email}}">
                                </div>
